        ...
        <AutoColumn style={{ padding: '1rem' }} gap="md">
          ...
          >
            {currency0 ? (
              <Row>
                ...
                <Text ml="8px" color="#000" >{currency0.symbol}</Text>
              </Row>
            ) : (
          ...
          {hasPosition && (
            ...
            >
              ...
              <StyledInternalLink to="/pool">
                <Text textAlign="center" color="#fff">{t('Manage this pool.')}</Text>
              </StyledInternalLink>
            </ColumnCenter>
          )}
          ...
          {currency0 && currency1 ? (
            pairState === PairState.EXISTS ? (
              hasPosition && pair ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text textAlign="center" color="#fff">{t('You don’t have liquidity in this pool yet.')}</Text>
                    <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                      <Text textAlign="center" color="#ff" >{t('Add Liquidity')}</Text>
                    </StyledInternalLink>
                  </AutoColumn>
                </LightCard>
              )
              ...
              <LightCard padding="45px 10px">
                <AutoColumn gap="sm" justify="center">
                  <Text textAlign="center" color="#fff">{t('No pool found.')}</Text>
                  <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                    {t('Create pool.')}
                  </StyledInternalLink>
                </AutoColumn>
