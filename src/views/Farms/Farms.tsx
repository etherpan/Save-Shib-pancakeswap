...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.saveshibperblock))
  ...
  return (
    <>
      <PageHeader background='#0d0d2bbd'>
            ...
            <Flex flexDirection="column" flex="1" alignSelf={['flex-start', null, null, 'center']}>
              ...
              <Flex>
                <Heading scale="lg" color="primary">
                  {tokenMode ? t('Stake Single token to earn SHB') : t('Stake LP tokens to earn SHB')}
                </Heading>
              </Flex>
            </Flex>
